...
<head>
    <title>订单</title>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=1920,initial-scale=1,maximum-scale=1.0,user-scalable=yes">
    <link rel="stylesheet"
                ...
                <div class="info-panel" style="height: 0px;margin-top: 0px;padding-top:100px">
                    ...
                    <div class="photo-name">
                        <a href="${pageContext.request.contextPath}/room.jsp?view=room&number=${data.rooms[i].number}">
                            <img class="main_info" src="/file/photo/${data.rooms[i].photo}" width="300" height="300">
    ...
    <div class="maxPage-summary" style="height: 500px;width:1920px">
        <div class="info-panel">
            <form class="input-info"
                  ...
                  method="post">
                <!-- 基本信息 -->
                <div class="panel panel-default" style="margin-left: 280px ;width: 510px;margin-top: 100px">
                    <div class="panel-heading">
                        <h3 class="panel-title">订单详情</h3>
                    </div>
